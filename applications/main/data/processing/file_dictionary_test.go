...
func TestManifestReleaseTier(t *testing.T) {
	base := DictionaryManifest{CommercialUse: true, NoncommercialUse: true, Modification: true, Redistribution: true}
...
func TestManifestRejectsEscapingDataFile(t *testing.T) {
	base := DictionaryManifest{SchemaVersion: 1, ID: "x", Name: "x", Source: "test", License: "CC0-1.0", SourceLanguage: "en", TargetLanguage: "ja", Format: DictionaryDataFormatTSVV1}
